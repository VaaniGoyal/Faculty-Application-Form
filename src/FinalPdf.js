...
function FinalPdf() {
    ...
    // ---------------------------------------------------------------------------------------------
    useEffect(() => {
        axios.get(`http://localhost:3000/api/application/getPersonalDetails/${app_number}`)
            .then(response => {
    ...
    const findEdIds = async (app_number) => {
        try {
            const response = await axios.get(`http://localhost:3000/api/edqualifications/getEducationalQualifications/${app_number}`);
    ...
    // ---------------------------------------------------------------------------------------------------
    useEffect(() => {
        axios.get(`http://localhost:3000/api/edqualifications/getPhdDetails/${phd_id}`)
            .then(response => {
    ...
    // ---------------------------------------------------------------------------------------------------
    useEffect(() => {
        axios.get(`http://localhost:3000/api/edqualifications/getPgDetails/${pg_id}`)
            .then(response => {
    ...
    // ---------------------------------------------------------------------------------------------------
    useEffect(() => {
        axios.get(`http://localhost:3000/api/edqualifications/getUgDetails/${ug_id}`)
            .then(response => {
    ...
    // ---------------------------------------------------------------------------------------------------
    useEffect(() => {
        axios.get(`http://localhost:3000/api/edqualifications/getSchoolDetails/${app_number}`)
            .then(response => {
    ...
    // ---------------------------------------------------------------------------------------------------
    useEffect(() => {
        axios.get(`http://localhost:3000/api/edqualifications/getAdditionalQualifications/${app_number}`)
            .then(response => {
    ...
    // ------------------------------------------------------------------------------------------------------
    useEffect(() => {
        axios.get(`http://localhost:3000/api/employment/getEmployment/${app_number}`)
            .then(response => {
    ...
    // ---------------------------------------------------------------------------------------------------
    useEffect(() => {
        axios.get(`http://localhost:3000/api/employment/getEmpHistory/${emp_id}`)
            .then(response => {
    ...
    // ---------------------------------------------------------------------------------------------------
    useEffect(() => {
        axios.get(`http://localhost:3000/api/employment/getTeachExp/${emp_id}`)
            .then(response => {
    ...
    // ---------------------------------------------------------------------------------------------------
    useEffect(() => {
        axios.get(`http://localhost:3000/api/employment/getResearchExp/${emp_id}`)
            .then(response => {
    ...
    // ---------------------------------------------------------------------------------------------------
    useEffect(() => {
        axios.get(`http://localhost:3000/api/employment/getIndustryExp/${emp_id}`)
            .then(response => {
            ...
            <table className="tab" style={{ borderCollapse: "collapse", border: "1px solid black", width: "100%" }}>
                ...
                <tbody>
                    <tr style={{ backgroundColor: "#f1f1f1" }}>
                        ...
                        {additionalData && additionalData.map(additional => (
